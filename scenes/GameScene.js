...
GameScene.CheckForWin = function()
{
	...
	{
		//player 1
		if (tilesValues[0][y] == 1 && tilesValues[1][y] == 1 && tilesValues[2][y] == 1)
		{
			alert("Player 1 won!");
			this.EndLevel();
		}
		...
		//player 2
		if (tilesValues[0][y] == 2 && tilesValues[1][y] == 2 && tilesValues[2][y] == 2)
		{
			alert("Player 2 won!");
			this.EndLevel();
		}
	...
	//cjeck all vertical win states
	for (x = 0; x < 3; x++)
	{
		//player 1
		if (tilesValues[x][0] == 1 && tilesValues[x][1] == 1 && tilesValues[x][2] == 1)
		{
			alert("Player 1 won!");
			this.EndLevel();
		}
		...
		//player 2
		if (tilesValues[x][0] == 2 && tilesValues[x][1] == 2 && tilesValues[x][2] == 2)
		{
			alert("Player 2 won!");
			this.EndLevel();
		}
	...
	//check diagonals
	//player 1
	if (tilesValues[0][0] == 1 && tilesValues[1][1] == 1 && tilesValues[2][2] == 1)
	{
		alert("Player 1 won!");
		this.EndLevel();
	}

	if (tilesValues[2][0] == 1 && tilesValues[1][1] == 1 && tilesValues[0][2] == 1)
	{
		alert("Player 1 won!");
		this.EndLevel();
	}
	...
	//player 2
	if (tilesValues[0][0] == 2 && tilesValues[1][1] == 2 && tilesValues[2][2] == 2)
	{
		alert("Player 2 won!");
		this.EndLevel();
	}

	if (tilesValues[2][0] == 2 && tilesValues[1][1] == 2 && tilesValues[0][2] == 2)
	{
		alert("Player 2 won!");
		this.EndLevel();
	}
